// new systems.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
#include <iostream>
#include <string>
...
void loggedInDonorMenu();
void donorSwitchStatement();
...
void loggedInDonorMenu() {
    ...
    cout << "3. Create Donor" << endl;
    cout << "4. Managing their information - make change " << endl;
    cout << "5. Booking for donation " << endl; //Time availibility for donation*/
    cout << "6. ?View availible times for donation" << endl;
    cout << "7. Admin options" << endl;
    cout << "8. Exit" << endl;
}
...
void makeChangeDonor() {
    ...
    int changerowOfIndividualsInfoChoice; // should not be able to choose this, will work on this later
    ...
    cout << "\n9.  Email : ";
    cout << "\n10. Contact Number : ";
    cout << "\n11. Date of last donation? (if known, enter \"unsure\" if so) : ";
    cout << "12. Location : ";
